...
AI drafting is optional but central to the Reply Draft workflow. Set `AI_PROVIDER=openai-compatible`, `AI_MODEL`, and `AI_API_KEY` to enable autogenerated Reply Drafts.
